...
No solo estudio código — lo uso para resolver problemas reales y construir cosas que funcionan.

🚀 En qué estoy trabajando

🤖 Bot de pedidos por WhatsApp — automatización para negocios pequeños (florerías, barberías, salones) usando Python, Flask y la API de Meta
📊 Aprendiendo automatización y análisis de datos con Python
💼 Construyendo un perfil dual: administración + tecnología

🧠 Un poco sobre mí

📡 Certificación Cisco en arquitectura de computadoras
